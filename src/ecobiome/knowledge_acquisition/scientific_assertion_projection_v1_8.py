...
PROJECTION_CONTRACT_VERSION = "1.8"
...
if canonical_sha256(PROJECTION_CONTRACT_DESCRIPTOR_V1_8) != PROJECTION_CONTRACT_SHA256:
...
def project_scientific_assertion_v1_8(
    candidate: Mapping[str, Any],
    *,
