import { Droplet, Waves, Fish, Leaf, Microscope, BookOpen, Images, LayoutDashboard, type LucideIcon } from 'lucide-react';

export type ViewKey = 'dashboard' | 'waterbodies' | 'diagnostics' | 'journal' | 'media';
